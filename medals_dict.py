...
file='country_medals.csv'

# with open(file,'w',encoding='utf-8',newline='') as file_data:
#     writer=csv.DictWriter(file_data,fieldnames=columns)
#     writer.writeheader()
...
#     writer.writerows(sorted(medals_table,key=key_sort))
...
with open(file,'w',encoding='utf-8',newline='') as file_data:
    writer=csv.DictWriter(file_data,fieldnames=columns,extrasaction='ignore')
    writer.writeheader()
